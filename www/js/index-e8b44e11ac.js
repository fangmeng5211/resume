...
/***/ function(module, exports, __webpack_require__) {
	...
	var SwiperAnimate=__webpack_require__(4);
	...
	/*保证swiper只显示一次*/
	/*for(var i=0;i<locallstorage.length;i++){
	    if (locallstorage.key[i]=='showTime'){
	        $('#myIscroll').show();
	    ...
	    locallstorage.setItem('showTime','1');
	}*/
	        ...
	        success:function(data){
	            ...
	            for(var i=0;i<data.length;i++){
	                ...
	                $('#thelist').append('<li>TITLE:'+data[i].category+'</li>')
	                            ...
	                            .append('<li>应用实间:'+data[i].time+'</li>');                
	            }

	             var IScroll=__webpack_require__(10);
